...
const Home = () => {
    ...
    <section className="banner">
        ...
        <div className="slider">
            <ul>
                <li><img src="src\assets\commons\styles\Banner.png" alt="1" /></li>
                <li><img src="src\assets\commons\styles\Banner 2.png" alt="2" /></li>
                <li><img src="src\assets\commons\styles\Banner 3.png" alt="3" /></li>
                <li><img src="src\assets\commons\styles\Banner 4.png" alt="4" /></li>
            </ul>
        </div>
