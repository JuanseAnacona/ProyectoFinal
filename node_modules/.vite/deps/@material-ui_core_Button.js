...
var ButtonBase = React21.forwardRef(function ButtonBase2(props, ref) {
  ...
  return React21.createElement(ComponentProp, _extends({
    ...
    React21.createElement(TouchRipple_default, _extends({
      ref: rippleRef,
      center: centerRipple
    }, TouchRippleProps))
  ) : null);
...
var Button = React22.forwardRef(function Button2(props, ref) {
  ...
  var startIcon = startIconProp && React22.createElement("span", {
    className: clsx_m_default(classes.startIcon, classes["iconSize".concat(capitalize(size))])
  }, startIconProp);
  var endIcon = endIconProp && React22.createElement("span", {
